...
COPY --from=build /root/shadowsocks-rust/examples/config_local.json /etc/shadowsocks-rust/config.json
...
COPY --from=build /root/shadowsocks-rust/examples/config_server.json /etc/shadowsocks-rust/config.json
